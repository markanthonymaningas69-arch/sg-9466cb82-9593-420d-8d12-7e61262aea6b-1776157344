...
const ADDONS = {
  extra_site: { id: "extra_site", name: "1 Site Personnel", description: "can handle 2 Projects", monthly: 500, annual: 5000 },
  extra_acc: { id: "extra_acc", name: "1 Accounting", description: "Add 1 extra accounting user", monthly: 400, annual: 4000 },
  purchasing: { id: "purchasing", name: "1 Purchasing", description: "Add 1 extra purchasing user", monthly: 300, annual: 3000 }
};
