...
const emptyForm = (currency: string): RateFormState => ({
  positionName: "",
...
export function ManpowerRateCatalogTab() {
  ...
  const [form, setForm] = useState<RateFormState>(() => emptyForm(currency));
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline">
                        {item.category === "office" ? "Office Staff" : "Construction Worker"}
                      </Badge>
                    </TableCell>
                    <TableCell>
