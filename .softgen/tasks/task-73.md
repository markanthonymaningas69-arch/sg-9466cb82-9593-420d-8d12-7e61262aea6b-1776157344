...
## Checklist
- [ ] Review the current Site Personnel tab layout and the existing Site Warehouse component behavior
- [ ] Add a dedicated Site Warehouse tab entry in the Site Personnel navigation
- [ ] Wire the Site Warehouse tab to the warehouse surface while preserving the Deliveries tab
- [ ] Verify project filtering still works for both warehouse-related surfaces
- [ ] Validate the Site Personnel module builds cleanly after the warehouse tab is restored
