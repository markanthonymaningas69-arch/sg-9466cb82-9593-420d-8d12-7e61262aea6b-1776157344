...
- [x] Group the purchase history table by receipt number so one receipt can show one or more materials
- [x] Add a View action that opens the receipt and lists all included materials
