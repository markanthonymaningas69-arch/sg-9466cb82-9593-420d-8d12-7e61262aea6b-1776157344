...
Follow-up bug: the Warehouse Project tab is still missing consumed materials because it is reading the wrong consumption table during page load. The tab must use the same `material_consumption` records generated by Site Personnel.
...
- [ ] Point the Warehouse Project tab to the Site Personnel material consumption table
