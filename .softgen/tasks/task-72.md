...
## Checklist
- [ ] Review the current Site Personnel page and related tab components to confirm the existing tab structure and data flow
- [ ] Reintroduce a dedicated Deliveries tab entry in the Site Personnel navigation
- [ ] Implement or reconnect the Deliveries tab component with the previous delivery management behavior using the current deliveries table
- [ ] Ensure project filtering, create/delete actions, and delivery listing work from the Site Personnel module
- [ ] Validate the Site Personnel page builds cleanly with the restored Deliveries tab
