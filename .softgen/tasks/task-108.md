...
## Checklist
- [x] Inspect the current Site Personnel tab shell and body card structure
- [x] Move or align the tab strip so it sits cleanly inside the card area
- [x] Keep tabs in one row with nowrap and horizontal scrolling
- [x] Reduce tab height, padding, and font size for a compact ERP-style rail
- [x] Prevent label wrapping and tighten long labels where needed
- [x] Validate the Site Personnel tab rail on smaller widths without overflow outside the card
