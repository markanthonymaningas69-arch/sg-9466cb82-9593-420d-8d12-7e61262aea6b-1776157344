...
## Checklist
- [x] Review the Site Warehouse tab, Material Usage tab, Site Purchase & Deliveries tab, service layer, and database schema for current material record sources
- [x] Define how Site Purchase restocks and Usage deductions map into a single warehouse material balance dataset
- [x] Update the service layer so Site Warehouse can load aggregated totals for restock, usage, remaining, and missing/excess values
- [x] Validate the linked warehouse data flow against the existing saved records
