...
## Checklist
- [ ] Inspect the current Site Personnel request submission flow and Approval Center request creation
- [ ] Inspect the Approval Center routing logic for Purchasing-bound requests
- [ ] Inspect the Purchasing inbox/unified list loading logic and linked request matching
- [ ] Verify the database schema and required linking fields for site requests, approval requests, purchases, and workflow tracking
- [ ] Fix the broken connection points between Site Personnel, Approval Center, and Purchasing
