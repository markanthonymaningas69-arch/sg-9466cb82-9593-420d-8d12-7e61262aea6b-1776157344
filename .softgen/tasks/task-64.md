...
Extend the same worker-type toggle behavior to the Attendance Summary, Leave Request, and Visa & Passport sections so users can switch those views between Admin Staff and Construction Workers too.

Keep the change scoped to the Human Resource tab and the related personnel section behavior and labels.
...
The Attendance Summary, Leave Request, and Visa & Passport sections update correctly for the selected staff type.